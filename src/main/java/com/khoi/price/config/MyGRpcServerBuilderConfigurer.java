...
public class MyGRpcServerBuilderConfigurer extends GRpcServerBuilderConfigurer {
  ...
  private final String certChainFilePath = "src/main/java/com/khoi/price/key/server.crt";
  private final String privateKeyFilePath = "src/main/java/com/khoi/price/key/server.pem";
